...
def sample_long_running_recognize(local_file_path, key_json):
    """
...
def main():
    ...
    parser.add_argument(
        "--local_file_path", type=str, default="audio_files/file.wav"
    )
    parser.add_argument(
        "--key_json", type=str, default="./mapmyindia-gv-6edff0c15c38.json"
    )
    args = parser.parse_args()

    sample_long_running_recognize(args.local_file_path, args.key_json)
